...
def create_page_1_ui(window,ui):
    ...
    """
    ui_page = {}
    ui_page["Button_0"] = pv.PvButton(container=window, x=250, y=10, width=200,
        height=50, text='SECUENCIA', font='assets/fonts/Lexend/Lexend.ttf', font_size=16,
    ...
    ui_page["Button_1"] = pv.PvButton(container=window, x=403, y=298, width=200,
        height=50, text='MANUAL', font='assets/fonts/Lexend/Lexend.ttf', font_size=16,
        ...
        corner_radius=43, border_style="solid", box_shadow='1px 2px 4px 0px rgba(0,0,0,0.2)', box_shadow_hover='0px 2px 4px 5px rgba(0,0,0,0.2)',
        icon_path=None, icon_position='left', icon_color=(255, 255, 255, 1), icon_color_hover=None,
        icon_spacing=0, icon_scale=1, paddings=(0, 0, 0, 0), is_visible=True,
        is_disabled=False, opacity=1, on_hover=None, on_click=None,
        on_release=None, tag=None)

    ui_page["Icon_2"] = pv.PvIcon(container=window, x=37, y=-1, width=50,
    ...
    ui_page["Button_3"] = pv.PvButton(container=window, x=138, y=298, width=200,
        height=50, text='AUTOMATICO', font='assets/fonts/Lexend/Lexend.ttf', font_size=16,
        font_color=(195, 187, 224, 1), font_color_hover=None, bold=False, italic=False,
        underline=False, strikethrough=False, idle_color=(255, 255, 255, 1), hover_color=None,
        clicked_color=None, border_color=(195, 187, 224, 1), border_hover_color=None, border_thickness=1,
        corner_radius=43, border_style="solid", box_shadow='1px 2px 4px 0px rgba(0,0,0,0.2)', box_shadow_hover='0px 2px 4px 5px rgba(0,0,0,0.2)',
    ...
    ui_page["Webcam_4"] = pv.PvWebcam(container=window, x=170, y=83, width=640,
        height=360, scale=0.5625, corner_radius=10, auto_start=True,
        ...
        opacity=1, webcam_id=1, on_hover=None, on_click=None,
        on_release=None, tag=None)
