...
def create_page_0_ui(window,ui):
    ...
    """
    ui_page = {}
    ui_page["Button_0"] = pv.PvButton(container=window, x=364, y=339, width=292,
    ...
    ui_page["Button_1"] = pv.PvButton(container=window, x=36, y=339, width=292,
    ...
    ui_page["Button_2"] = pv.PvButton(container=window, x=697, y=339, width=292,
    ...
    ui_page["Button_3"] = pv.PvButton(container=window, x=36, y=454, width=292,
        height=75, text='ESTADO CONFIGS', font='assets/fonts/Poppins/Poppins.ttf', font_size=23,
        font_color=(255, 255, 255, 1), font_color_hover=None, bold=False, italic=False,
        underline=False, strikethrough=False, idle_color=(56, 136, 255, 1), hover_color=None,
        clicked_color=None, border_color=(100, 100, 100, 1), border_hover_color=None, border_thickness=0,
        corner_radius=0, border_style="solid", box_shadow='1px 2px 4px 0px rgba(0,0,0,0.2)', box_shadow_hover='0px 2px 4px 5px rgba(0,0,0,0.2)',
    ...
    ui_page["Button_4"] = pv.PvButton(container=window, x=364, y=454, width=292,
    ...
    ui_page["Button_5"] = pv.PvButton(container=window, x=697, y=454, width=292,
        height=75, text='VERSION SW', font='assets/fonts/Poppins/Poppins.ttf', font_size=23,
        font_color=(255, 255, 255, 1), font_color_hover=None, bold=False, italic=False,
        underline=False, strikethrough=False, idle_color=(56, 136, 255, 1), hover_color=None,
        clicked_color=None, border_color=(100, 100, 100, 1), border_hover_color=None, border_thickness=0,
        corner_radius=0, border_style="solid", box_shadow='1px 2px 4px 0px rgba(0,0,0,0.2)', box_shadow_hover='0px 2px 4px 5px rgba(0,0,0,0.2)',
