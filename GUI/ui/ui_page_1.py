...
def create_page_1_ui(window,ui):
    ...
    """
    ui_page = {}
    ui_page["Button_0"] = pv.PvButton(container=window, x=365, y=15, width=292,
    ...
    ui_page["Button_1"] = pv.PvButton(container=window, x=589, y=447, width=292,
    ...
    ui_page["Icon_2"] = pv.PvIcon(container=window, x=54, y=-1, width=73,
    ...
    ui_page["Button_3"] = pv.PvButton(container=window, x=201, y=447, width=292,
    ...
    ui_page["Webcam_4"] = pv.PvWebcam(container=window, x=150, y=110, width=720,
        height=405, scale=0.833, corner_radius=14, auto_start=True,
